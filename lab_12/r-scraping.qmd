...
1. Are there any gender and race trends for where candidates have leads? For example - does Cox tend to lead in majority-male counties in Maryland? Or does Ficker have leads in counties that are all a majority of one race or age group?
2. Did counties with more college-educated people tend to favor a certain candidate?
