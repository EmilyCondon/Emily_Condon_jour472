...
MediaSalary %>%  filter(Salary == 230504) 
 
Answer: senior reporter ProPublica 230504 
...
summary(Editors$Salary)
 ...
 Min.  1st Qu.   Median     Mean  3rd Qu.     Max. 
    11.5  45000.0  60240.0  64378.6  75000.0 245000.0 
    
Answer: Median $60,240

3: Find highest paid editor. Resent them.   
Editors %>%  filter(Salary == 245000) 

Answer: editorial director CondeNast 
...
Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
    800   50000   52000   69692   55000  350000 
    
NYT %>%  filter(Salary == 350000) 


```{r}
Executive Editor, News; noanswer; black
```

```         
3: Search for Bloomberg,  check median salary, compare to NYT results above.
```
Bloomberg <- MediaBucks %>% filter(COMPANY == "Bloomberg")
summary(Bloomberg$Salary)

Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
  38000   47750   50350   50014   54125   60000 

```{r}
The median income of Bloomberg is $50,350 and the New York Times median income is higher at $52,000.
