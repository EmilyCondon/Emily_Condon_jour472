...
#In order to do this, I would first use the clean_data function to make everything lowercase. Then I would filter for the variations of state of Maryland and do something similar to line 208 where I add a row that says "MD" or "maryland" so that everything has a similar baseline. From therw I would use a summarise function on my new Maryland data set on the population column.
